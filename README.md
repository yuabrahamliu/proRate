...
Several metagene plots can be returned, focusing on the various gene regions defined. Because 2 specific genes, Tbl1x and Gk, have been transferred to the parameter `savegenenames`, their reads distributions are also plotted and returned.
