...
To domenstrate the functions of *proRate*, this tutorial uses some data that accompany with the package, including 4 bam files and a txt file. 
...
Among the target genes defined, if there are some whose reads values need to be checked in detail, a vector containing the symbols of these genes can be transferred to the parameter `savegenenames`, and then their normalized reads values for each bp along the gene body will be returned with the final results. In addtion, the `plotgenenames` parameter can be set as TRUE to futher plot and show the Pol II depleted region and occupied region of these genes.



Hence, the transcriptoin rate for the genes in WT C2C12 cells can be calculated using the following command.
...
The result `wtrates` is a list and its most important element is a data.frame named "report". It contains the distance that Pol II passes (i.e. the length of the Pol II depleted region) on each gene template, which is inferred using the least sum of square (LSS) method of *proRate*. Additionally, the Pol II travel time (15 min here for all genes), the final rate calculated from these 2 values, the statistical signficance of the results, as well as many other information are also included in this data.frame. A part of it is shown below.
...
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/tbl1xtracks_catch.PNG")
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/Gktracks_catch.PNG")
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/tbl1xbins.png")
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/Gkbins.png")
```

The transition point at this stage is actually a bin including hundreds of bases. To get a more precise position, this bin and its downstream one will be expanded to a single base resolution. The LSS method will be used on them to find the base with the smallest sum of square. This point is the final transition point. The single base level results on the 2 expanded bins are also plotted by `calrate`, for Tbl1x and Gk resepctively.

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/tbl1xextends.png")
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/Gkextends.png")
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/intragccomp.png")
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/intraexoncomp.png")
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/kmerplot.png")
```
...
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/metatss1000.png")
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/metatss500.png")
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/metatts1000.png")
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/metagenebody.png")
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/metagenebody1000.png")
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/metaTbl1x_catch.PNG")
```

```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("C:/Users/abrah/Desktop/tmp/enlongation/elongHMM/tutorial_res/figs/metaGk_catch.PNG")
```
...
Pause index (or pausing index) is the ratio of transcription polymeras II signal density near a gene promoter to signal density within the gene body *(Williams, et al., 2015)*. A gene with a large pause index means most poymerase II molecules accumulate in its promoter region, while few of them enter into the downstream gene body. Hence, most polymerases pause in the promoter and cannot be released to complete the downstream transcription.
