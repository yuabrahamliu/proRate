...
intracompare <- function(inferres = allrateres, targetgenes = NULL, quantilenum = 4){
  ...
  genes in quantile1 group have the lowest rates. The other data.frame records the 
...
intercompare <- function(inferresmat = rates, groupnames){
  ...
  conditions. Can be generated using the funciont orgintercompareinput.
  @param groupnames A vector with the elements correspond to the condition names of the 
