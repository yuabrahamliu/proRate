...
getgc <- function(targetfile, genomename = 'mm10', genenames = NULL){
  ...
  @param targetfile The directory of the file indicating the gene ranges whose GC contents need 
...
getkmer <- function(targetfile, genomename = 'mm10', k = 6,
  ...
  @param targetfile The directory of the file indicating the gene ranges whose kmer need 
